...
import { ChevronLeft, ChevronRight, Layout, Server, Layers, BarChart3 } from "lucide-react"
...
export function Skills() {
  ...
  const nextIsland = () => setActiveIsland((prev) => (prev + 1) % skillIslands.length)
  const prevIsland = () => setActiveIsland((prev) => (prev - 1 + skillIslands.length) % skillIslands.length)
        ...
        <div className="relative group max-w-5xl mx-auto">
          ...
          >
            <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-12">
              <div className="flex items-center gap-6">
                <div className="bg-primary/20 p-5 rounded-3xl text-primary shadow-lg shadow-primary/20 animate-pulse">
                  {skillIslands[activeIsland].icon}
                </div>
                <div>
                  <h3 className="text-3xl font-bold tracking-tight mb-1">{skillIslands[activeIsland].title}</h3>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
              {skillIslands[activeIsland].skills.map((skill) => (
